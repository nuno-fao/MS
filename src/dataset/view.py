...
graph_data_nodes = np.loadtxt('files/nodes.csv', dtype='str', delimiter=',', encoding="utf-8-sig", skiprows=1)
graph_data_edges = np.loadtxt('files/edges.csv', dtype='str', delimiter=',', encoding="utf-8-sig", skiprows=1)
path_edges = []
try:
